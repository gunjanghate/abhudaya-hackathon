...
const page = () => {
  return (
    <>
      ...
      <div className="back-to bg-blue-400 w-32 px-2 rounded-md border-2 border-blue-500 lg:w-44 lg:pl-5 ml-2 hover:text-white hover:bg-blue-500 transition-colors">
